...
class sports_gradation_certificate extends Model
{
    ...
    protected $fillable = [
        ...
        'aadhaar_card','domicile_certificate','sports_certificate','more_than25_photo','profile_picture','status','approve_reject_datetime','dso_id','certificate_pdf','enquiry_pdf','enquiry_pdf_datetime','replied_pdf','replied_pdf_datetime','type_of_event','terms_conditions','rejection_remarks','certificate_upload_datetime'
    ];
}
