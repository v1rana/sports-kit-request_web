	...
	<div class="table-responsive">
		<table class="table table-bordered bg-white table-hover w-100">
			...
			<tbody>
				...
				<tr>
					<td>{{ $index + 1 }}.</td>
					<td>{{ $request->applicant_name ?? 'Rajender singh' }}</td>
					...
					<td>
						<div>
							@if($request->status == 'Approved')
								<span class="badge rounded-pill bg-success w-100"><i class="fa-solid fa-thumbs-up"></i> Approved</span>
							@elseif($request->status == 'Rejected')
								<span class="badge rounded-pill bg-danger w-100"><i class="fa-solid fa-ban"></i>  Rejected</span>
							@elseif($request->status == 'Verified')
								<span class="badge rounded-pill bg-info w-100"><i class="fa-solid fa-check"></i> Verified</span>
