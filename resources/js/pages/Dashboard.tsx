                        ...
                        <div id="qbox-container">
                            ...
                            {!isSubmitted && !isSubmitting && (
                                <div>
                                    ...
                                    >
                                        <h3 className="text-center">Educational Qualification</h3>
                                    ...
                                    >
                                        ...
                                        <div className="col-md-12">
                                            <div className="form-check">
                                                <input className="form-check-input" type="checkbox" name="medalWon" id="medalGold" value="medalGold" />
                                                <label className="form-check-label" htmlFor="medalGold">Physical Disability </label>
                                            </div>
                                        </div>
                                        <div className="col-md-6">
                                            <label className="form-label">
                            ...
                            {isSubmitted && (
                                <div className="mt-5">
                                    ...
                                    <p>
                                        Stay safe: wash your hands, maintain
